...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  """Get train data into data_dir, create vocabularies and tokenize data.
  Args:
    data_dir: directory in which the data sets will be stored.
    en_vocabulary_size: size of the English vocabulary to create and use.
    vi_vocabulary_size: size of the Vietnamese vocabulary to create and use.
    tokenizer: a function to use to tokenize each data sentence;
      if None, basic_tokenizer will be used.
  Returns:
    A tuple of 6 elements:
      (1) path to the token-ids for English training data-set,
      (2) path to the token-ids for Vietnamese training data-set,
      (3) path to the token-ids for English development data-set,
      (4) path to the token-ids for Vietnamese development data-set,
  ...
  to_train_path = train_path + ".vi"
  from_dev_path = dev_path + ".en"
  to_dev_path = dev_path + ".vi"
...
def prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocabulary_size,
  ...
  to_vocab_path = os.path.join(data_dir, "vocab%d.vi" % to_vocabulary_size)
  from_vocab_path = os.path.join(data_dir, "vocab%d.en" % from_vocabulary_size)
  ...
  to_train_ids_path = to_train_path + (".ids%d.vi" % to_vocabulary_size)
  from_train_ids_path = from_train_path + (".ids%d.en" % from_vocabulary_size)
  ...
  to_dev_ids_path = to_dev_path + (".ids%d.vi" % to_vocabulary_size)
  from_dev_ids_path = from_dev_path + (".ids%d.en" % from_vocabulary_size)
